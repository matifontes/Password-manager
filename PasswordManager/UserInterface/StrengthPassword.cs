...
namespace UserInterface
{
    public partial class StrengthPassword : UserControl
    {
        ...
        public StrengthPassword(PasswordsController passwords, CategoriesController categories, DataBreachesController dBreaches)
        {
            InitializeComponent();
        ...
        {
            ListStrengthPasswords redPasswords = new ListStrengthPasswords(this.passwords,categories, passwords.ListPasswordsByStrength(RED_STRENGTH), this.dBreachesController);
        ...
        {
            ListStrengthPasswords orangePasswords = new ListStrengthPasswords(this.passwords, categories, passwords.ListPasswordsByStrength(ORANGE_STRENGTH), this.dBreachesController);
        ...
        {
            ListStrengthPasswords yellowPasswords = new ListStrengthPasswords(this.passwords, categories, passwords.ListPasswordsByStrength(YELLOW_STRENGTH), this.dBreachesController);
        ...
        {
            ListStrengthPasswords lightGreenPasswords = new ListStrengthPasswords(this.passwords, categories, passwords.ListPasswordsByStrength(LIGHTGREEN_STRENGTH), this.dBreachesController);
        ...
        {
            ListStrengthPasswords darkGreenPasswords = new ListStrengthPasswords(this.passwords, categories, passwords.ListPasswordsByStrength(DARKGREEN_STRENGTH), this.dBreachesController);
